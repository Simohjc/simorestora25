...
export const CONTACT = [
  { key: "address",  icon: <CiLocationOn />,  value: `4400 travis st, Houston TX, 77056` },
  { key: "phone",  icon: <MdPhoneForwarded />, value: `+1(832) 588-4481` },
  { key: "email",  icon: <MdOutlineEmail />, value: `simo@restaura.com `},
  { key: "hours", 
                    value: [
...
export const SOCIAL_MEDIA_LINKS = [
  {
    ...
    icon: <FaFacebook fontSize={30} className="hover:opacity-80 text-[#039BE5]" />,
  },

  {
    href: "https://instagram.com/",
    icon: <FaInstagram fontSize={30} className="hover:opacity-80 text-[#FF6F00]" />,
  },
  {
    href: "https://twitter.com/",
    icon: <FaTwitter fontSize={30} className="hover:opacity-80 text-[#03A9F4]" />,
  },
  {
    href: "https://whatsapp.com/",
    icon: <FaWhatsapp fontSize={30} className="hover:opacity-80 text-[#25D366]" />,
  },
];
